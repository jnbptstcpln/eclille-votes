...
class Election(models.Model):
    ...
    is_active = models.BooleanField(default=False, verbose_name="Le vote est actif et accessible (dans le respect des dates d'ouverture)")
...
class VoteUser(models.Model):
    ...
    user = models.ForeignKey(User, related_name="votes_custom", on_delete=models.CASCADE)
...
class VoteProxy(models.Model):
    ...
    user = models.ForeignKey(User, related_name="votes_custom_proxies", on_delete=models.CASCADE)
    names = models.TextField(max_length=1000, verbose_name="Identités des procurants", help_text="Indiqué une personne par ligne")

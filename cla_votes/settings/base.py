"""
Django settings for cla_votes project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'cla_votes.context_processors.cla_votes_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'cla_votes.wsgi.application'
